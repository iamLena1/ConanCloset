<?php
    ...
    $clothing_data=getAllClothing($connection); // to get all the product from the database
   
    include("..\Classes\Connect.php");
    include("..\Classes\LoginClass.php");
    include("..\Classes\ProfileClass.php");

    function getAllClothing($connection)
{
...
if (isset($_POST['add_to_cart']) && isset($_POST['product_id'])) {
  ...
  echo "window.location.href = 'clothingPage.php';";
  echo "</script>";
      ...
      <div class="clotheing-cosplay">
        ...
        <div class="products-container">
            ...
            foreach ($clothing_data as $product) {
                ...
                $product_image = 'data:image/jpeg;base64,'. base64_encode($product['Image']).'"style: height="80px;"/>'; // Assuming "Image" is the column name
...
?>
                ...
                if ($productCount % 4 === 0) {
                    echo '</div>'; // Close product row after every 4 products
                }
              }
            ?>
