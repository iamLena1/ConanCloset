<?php
    require "..\db_conn.php";
    $figures_data=getAllFigures($connection); // to get all the product from the database
   
    include("..\Classes\Connect.php");
    include("..\Classes\LoginClass.php");
    include("..\Classes\ProfileClass.php");
    
    function getAllFigures($connection)
    {
        $sql = "SELECT * FROM product WHERE Categry='figures'";
...
if (isset($_POST['add_to_cart']) && isset($_POST['product_id'])) {
  ...
  echo "window.location.href = 'FiguresPage.php';";
  echo "</script>";
...
<div class="figures">
 <div class="figures-products" 
   style="
     background: url(FiguresBG.jpg) center; 
    ...
    <div class="figures2">
      ...
      <div class="products-container">
        <?php
          ...
          foreach ($figures_data as $product) {
