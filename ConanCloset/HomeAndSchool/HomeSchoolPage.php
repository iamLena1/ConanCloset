...
<?php
    require "..\db_conn.php";
    $school_data=getAllSchool($connection); // to get all the product from the database
   
    include("..\Classes\Connect.php");
    include("..\Classes\LoginClass.php");
    include("..\Classes\ProfileClass.php");
    
    function getAllSchool($connection)
    {
        $sql = "SELECT * FROM product WHERE Categry='Home & school'";
...
if (isset($_POST['add_to_cart']) && isset($_POST['product_id'])) {
  ...
  echo "window.location.href = 'HomeSchoolPage.php';";
  echo "</script>";
    ...
    <div class="home-school">
      ...
      <div class="products-container">
        <?php
          ...
          foreach ($school_data as $product) {
